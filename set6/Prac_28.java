...
System.out.println("Usage: java CharCount <file> <character>"); return;
}
...
try (BufferedReader reader = new BufferedReader(new FileReader(fileName))) { int charCount = 0;
int c;
while ((c = reader.read()) != -1) { if (c == targetChar) {
charCount++;
}
}
